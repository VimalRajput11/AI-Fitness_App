      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 right-0 mt-2 bg-white/20 dark:bg-white/10 backdrop-blur-lg rounded-xl border border-white/20 shadow-2xl z-50 max-h-60 overflow-y-auto"
          >
